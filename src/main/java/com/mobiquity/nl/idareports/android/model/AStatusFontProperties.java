...
@Entity
@Table(name = "astatus_font_properties")
public class AStatusFontProperties {
    ...
    public AStatusFontProperties() {
    }

    public AStatusFontProperties(long id, String mobileElement, String saveReadFile, String uiFontName, boolean bold, boolean italic, boolean underline, boolean monospace, boolean serif, boolean smallcaps, int pointSize, String uiFontNameS, boolean boldS, boolean italicS, boolean underlineS, boolean monospaceS, boolean serifS, boolean smallcapsS, int pointSizeS) {
        this.id = id;
